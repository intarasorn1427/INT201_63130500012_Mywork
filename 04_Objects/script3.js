...
//--------------------------------------------
// let per1 = { id: 1 , name : Jaehyun }  //per1 is objectr variable   ,store memmory address
// let per2 = per1;

// doSomething(per2); //เรียกใช้func doSomething()

// function doSomething(p) {  //p=per2   per2 ให้ memmoer sddressเเก่ p
...
// let per1 = { id: 1, name: 'Joe' };  //per1 is an object variable, 
// let per2 = per1;   //store memory address that points to object properties
