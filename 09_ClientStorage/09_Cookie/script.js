...
class CookieUtil {
  ...
  // document.cookie="username='Chayada'; expires=new Date(); path= '/INT201'; domain='www.google.com'";
  ...
  static unset(name) { //ลบcookie
    CookieUtil.set(name, '', new Date(0)); //date ที่ผ่านมาเเล้ว
  }
}
